    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendButton.setOnClickListener {
            ...
            if (email.isEmpty()){
                ...
                //firebase methodis sadac password resetistvis vgazvnit emails taskshi gvijdeba warmatebit moxda tua ara gagzavna
                    //addoncompelelisteneria amis pasuxismgebeli
